...
Expected: exit code 0, `campaign_status: COMPLETE`, tables and figures under the output directory, and a copy under `results/publication/`. Submission remains blocked at the job cap. This command must not call IBM Runtime `Sampler.run`.
