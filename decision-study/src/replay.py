...
def replay_all() -> dict[str, Any]:
    ...
    for instance in hardware_instances():
        ...
        payload.append(replay_fixture(instance, shots))
        ...
        for pool_name, pool in (("p1", shots), ("p2", shots2)):
            for prefix in PREFIXES:
                for deadline in DEADLINES:
                    ...
                    out = apply_policy("P2", spec, pool[:prefix], incumbent, now_elapsed=min(deadline, 1.0), linkage=linkage, trusted_source=spec)
